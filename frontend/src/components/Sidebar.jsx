...
const Sidebar = () => {
  ...
  const allMenuItems = [
    ...
    { name: 'Finance Dashboard', path: '/finance', icon: <PieChart size={20} />, roles: ['Admin', 'Manager', 'Finance'] },
    { name: 'Cash In Bank', path: '/cash-in-bank', icon: <CreditCard size={20} />, roles: ['Admin', 'Manager', 'Finance'] },
    { name: 'Journal', path: '/journal', icon: <FileText size={20} />, roles: ['Admin', 'Manager', 'Finance'] },
    { name: 'Chart of Accounts', path: '/chart-of-accounts', icon: <Activity size={20} />, roles: ['Admin', 'Manager', 'Finance'] },
