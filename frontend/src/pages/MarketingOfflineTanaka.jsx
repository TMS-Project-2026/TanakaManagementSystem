...
export default function MarketingOfflineTanaka({ embedded = false }) {
  ...
  const handleExportExcel = () => {
    ...
    if (activeTab === 'reports') {
      ...
      fileName = `Orders_Offline_Tanaka_${new Date().toISOString().split('T')[0]}`;
    }
                    ...
                    <div className="p-12 text-slate-800 font-sans">
                      <div className="flex justify-between items-start border-b-2 border-[#990000] pb-6 mb-8">
                        <div>
                          ...
                          <p className="text-xs text-slate-400 mt-1 max-w-xs">Jl. Contoh Alamat No. 123, Kota Tanaka, Indonesia<br />Telp: (021) 123-4567 | Email: info@tanaka.com</p>
                        </div>
