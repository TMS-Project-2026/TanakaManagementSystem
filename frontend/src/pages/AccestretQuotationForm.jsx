                        ...
                        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                            ...
                            <div className="flex justify-end">
                                <div className="w-full md:w-1/2 lg:w-5/12 space-y-4 bg-purple-50 p-6 rounded-2xl border border-purple-100">
                                    ...
                                    <div className="flex items-center justify-between gap-4"><label className="text-sm font-bold text-gray-600 w-1/3">PPN (%)</label><input type="number" step="any" name="ppn_persen" value={form.ppn_persen} onChange={handleChange} min="0" max="100" className="w-1/4 p-2 border border-purple-200 rounded-lg text-right focus:ring-2 focus:ring-purple-300 outline-none" /><span className="w-5/12 text-right text-sm font-bold text-gray-700">Rp {form.jumlah_ppn.toLocaleString('id-ID')}</span></div>
