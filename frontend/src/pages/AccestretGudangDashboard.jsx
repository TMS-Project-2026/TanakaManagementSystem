                                    ...
                                    {data.chartData && data.chartData.length > 0 ? (
                                        <ResponsiveContainer width="100%" height="100%">
                                            <LineChart data={data.chartData}>
                                                ...
                                                <Line type="monotone" dataKey="masuk"  name="Barang Masuk"  stroke="#990000" strokeWidth={4} dot={{ r: 4, fill: '#990000', strokeWidth: 2, stroke: '#fff' }} activeDot={{ r: 6 }} />
                                                <Line type="monotone" dataKey="keluar" name="Barang Keluar" stroke="#ff4d4d" strokeWidth={4} dot={{ r: 4, fill: '#ff4d4d', strokeWidth: 2, stroke: '#fff' }} activeDot={{ r: 6 }} />
                                            </LineChart>
                                        </ResponsiveContainer>
                                    ) : (
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 lg:col-span-2 flex flex-col">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 overflow-y-auto max-h-[300px] pr-1 custom-scrollbar">
                                    {data.deadStock && data.deadStock.length > 0 ? (
                                        ...
                                        <div className="text-center text-xs text-gray-400 font-bold italic py-12 col-span-full">
