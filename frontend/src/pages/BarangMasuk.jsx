...
import { PlusCircle, CheckCircle, Trash2, Plus } from 'lucide-react';
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody>
                                    ...
                                    {historyList.length === 0 && (
                                        <tr><td colSpan={6} className="p-6 text-center text-gray-500">Belum ada riwayat barang masuk</td></tr>
                                    )}
                                </tbody>
                            </table>
                        </div>
