...
const SemuaPembelian = () => {
    ...
    return (
        <div className="p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-6 border-b pb-2">Semua Transaksi Pembelian (Jurnal)</h2>
            ...
            <ReportFilter 
                ...
                exportFileName="Data_Transaksi_Pembelian"
